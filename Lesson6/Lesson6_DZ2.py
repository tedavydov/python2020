...
# рассчитаем массу асфальта для покрытия толщиной 5 см
print(f"на покрытие дороги ушло {r.weight(5) / 1000:.01f} тонн асфальта")

# рассчитаем массу асфальта (по умолчанию покрытие толщиной 1 см)
print(f'на покрытие дороги ушло бы {r.weight() / 1000:.01f} тонн асфальта если делать "как обычно"')
